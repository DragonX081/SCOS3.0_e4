...
public class fragment_orderFood extends android.support.v4.app.Fragment {
    ...
    private List<FoodInfo> foodInfos,foodOrderList;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            ArrayList list = bundle.getParcelableArrayList("foodInfosLabel");
            foodInfos = (List<FoodInfo>) list.get(0);
            foodTypeLabels = (ArrayList<String>) list.get(1);
            foodLabelPositions = (int[]) list.get(2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        init_rg_foodtype(rg_foodTypeLabel,foodTypeLabels);
